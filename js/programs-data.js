const MOVEMENT_PATTERNS = {
  ...
  'vertical-push': {
    label: 'Vertical Push',
    examples: ['Overhead Press', 'Landmine Press', 'Incline Dumbbell Press'],
  },
  'vertical-pull': {
    label: 'Vertical Pull',
...
const PROGRAM_COLLECTIONS = [
  {
    ...
    summary: 'Alternate Day A and Day B for two full-body sessions each week.',
  ...
  'full-body-2x': [
    {
      id: 'day-a',
      title: 'Day A',
      intro: 'Full-body session built around squat-dominant patterns with horizontal pushing and pulling.',
      guidance:
        '6–10 reps · 2–3 sets · 1+ min rest · Train within 3 reps of failure on every set.',
      slots: [
        { patternId: 'squat' },
        { patternId: 'horizontal-press' },
        { patternId: 'hip-extension' },
        { patternId: 'horizontal-pull' },
        { choice: ['leg-extension', 'tricep-extension'] },
      ],
    },
    {
      id: 'day-b',
      title: 'Day B',
      intro: 'Full-body session built around hinge-dominant patterns with vertical pushing and pulling.',
      guidance:
