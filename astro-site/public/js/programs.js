(function () {
  ...
  function buildSlotRow(slot, index) {
    ...
    if (slot.choice && slot.choice.length) {
      ...
      label.textContent = slot.choiceLabel || 'Choose one';
      body.appendChild(label);

      const optionsLabel = document.createElement('p');
      optionsLabel.className = 'workout-slot__options-label';
      optionsLabel.textContent = 'Options';
      body.appendChild(optionsLabel);

      const optionsList = document.createElement('div');
      optionsList.className = 'workout-slot__options';

      slot.choice.forEach(function (patternId) {
        const option = document.createElement('p');
        option.className = 'workout-slot__option';
